        ...
        <Layout style={layoutStyle}>
          ...
          <Layout>
            ...
            <Content style={chartStyle}>
              {/* <h3 style={{ margin: "0", color: "#1E3175", marrginTop: "-100px", marginBottom: "10px"}}>Chart</h3> */}
            ...
            <Sider width="35%" style={switchStyle}>
              ...
              <h3 style={{ margin: "0", marginLeft: "-50px", color: "#1E3175", marginTop: "20px" }}>Device's Switch</h3>
              <Switches2 />
            </Sider>
          </Layout>
        </Layout>
